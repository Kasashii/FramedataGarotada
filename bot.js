...
client.on("message", async message => {
 ...
 const leaderboard = ("```js\n- TORNEIO DA GAROTADA - > 2021: ```\n```LEADERBOARD  --   PLAYER   -------   SCORE```\n:zero::one:|:stop_button:            **|**     `Ikkisoad`                  **|**     *82/39*\n:zero::two:|:stop_button:            **|**     `Ryuuji_kei`              **|**     *68/60*\n:zero::three:|:stop_button:            **|**     `ShinyPine`                **|**     *61/62*\n:zero::four:|:stop_button:            **|**     `Vargão`                      **|**     *32/27*\n:zero::five:|:arrow_up_small:            **|**     `Kasashi`                    **|**     *27/50*\n:zero::six:|:arrow_down_small:            **|**     `Aristal`                    **|**     *25/15*\n:zero::seven:|:stop_button:            **|**     `CrushMachine`          **|**    *15/1*\n:zero::eight:|:stop_button:            **|**     `danieldx`                  **|**    *13/8*\n:zero::nine:|:stop_button:            **|**     `Shieda`                      **|**    *13/51*\n:one::zero:|:stop_button:            **|**     `LochNessMobster`   **|**    *12/10*\n:one::one:|:stop_button:            **|**     `Athylia`                   **|**     *12/27*\n:one::two:|:stop_button:            **|**     `handsforup`             **|**     *9/2*\n:one::three:|:stop_button:            **|**     `Kaito`                       **|**     *9/11*\n:one::four:|:stop_button:            **|**     `Army`                         **|**     *3/6*\n:one::five:|:stop_button:            **|**     `Sewdras`                   **|**     *1/6*")
